...
def kkI():  
    ...
    I=70                                                    #change for different irradiances
    ...
    Dd=0.25                                                 #change for different growth rate
    D=Dd/(3600*24)
...
#OOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO
    ...
    StackPlotColorsN=(Color_Other,Color_Nstore,Color_Photo,Color_Bio,Color_other)
    StackPlotColorsP=(Color_Other,Color_Photo,Color_Bio,Color_Pstore)
    StackPlotColorsC=(Color_Other,Color_Nstore,Color_Photo,Color_Bio,Color_other)
    ...
    if Plot_C_stack==1:
        ...
        pyplot.stackplot(Tc,Cessential_plot+Cconst_protein_plot+Cdna_const_plot+Cdna_variable_plot,Cnstore_plot,\
                  Cphoto_plot+CthylakoidPG_plot+Cchl_plot,Crna_const_plot+Crna_variable_plot+Cbiosynth_plot,Cother_plot,colors=StackPlotColorsC,alpha=0.75)
        ...
        nsleg=mpat.Patch(color='#882255',label='Nitrogen Storage',alpha=0.75)
        pyplot.legend(handles=[eleg,pleg,bleg,sleg,nsleg],loc='upper center',bbox_to_anchor=(0.5,-0.25), ncol=2,fontsize='x-small',frameon=False)


        pyplot.figure(2,figsize=(7.7,6.5))
        pyplot.stackplot(Tc,Nconst_protein_plot+Ndna_const_plot+Ndna_variable_plot,Nstore_plot,Nphoto_plot+Nchl_plot,Nbiosynth_plot+Nrna_variable_plot+Nrna_const_plot,colors=StackPlotColorsN,alpha=0.75)
        pyplot.xlabel('Temperature (\u2103)', fontsize=25)                       
        ...
        bleg=mpat.Patch(color='#44AA99',label='Biosynthesis',alpha=0.75)
        nsleg=mpat.Patch(color='#882255',label='Nitrogen Storage',alpha=0.75)
        pyplot.legend(handles=[nsleg,eleg],loc='upper center',bbox_to_anchor=(0.65,-0.25), ncol=3,fontsize='x-small',frameon=False)
