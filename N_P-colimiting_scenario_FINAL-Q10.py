...
CFM-Phyto with temperature. Co-limiting nutrient scenario
...
#AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA
def kkI():   
    I=70                             #constant irradiance (umol photons m-2 s-1)
    ...
    Nstore_max=0                     # no storage for co-limitation scenario #2.91679384515998E-15     #(molN cell-1) Constant protein pool in nitrogen (193-25)
...
#OOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO
    ...
    if Plot_C_stack==1:
        ...
        pyplot.ylabel('Carbon allocation ($\%$)', fontsize=25)  
