...
class Healey85C:
    def __init__(self,Lightintensity,plotcolor,DL,L,DChl_Nlimited,Chl_Nlimited,D_PtoC,PtoC,D_NtoC,NtoC, D_NtoP, NtoP,Dchl,chl,i):
...
def healey85C():
    data0=genfromtxt('Healey_1985_N_limited_A_plimited_chl_added.csv', delimiter=',')
